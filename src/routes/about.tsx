  ...
  head: () => ({
    meta: [
      { title: "About — Protech Computer Education" },
      {
        name: "description",
        content:
          "How Protech Computer Education teaches programming and web technologies: structured courses, practical work, projects and internship exposure in Khordha, Odisha.",
      },
      { property: "og:title", content: "About Protech Computer Education" },
      {
        property: "og:description",
        content: "Our story, our approach and what we teach at Bolgarh, Khordha.",
      },
      { rel: "canonical", href: "https://protech-computer-education.lovable.app/about" },
    ],
  }),
  component: AboutPage,
});
