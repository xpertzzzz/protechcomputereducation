  ...
  head: () => ({
    meta: [
      { title: "Privacy Policy — Protech Computer Education" },
      {
        name: "description",
        content:
          "How Protech Computer Education collects, uses and protects the personal information of students and enquirers.",
      },
      { property: "og:title", content: "Privacy Policy — Protech Computer Education" },
      { property: "og:description", content: "How we handle student and enquiry information." },
      { rel: "canonical", href: "https://protech-computer-education.lovable.app/privacy-policy" },
    ],
  }),
