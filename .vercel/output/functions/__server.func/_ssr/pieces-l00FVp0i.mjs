...
import { a as getSettingsFn, i as getPublicTestimonialsFn, n as getPublicCoursesFn, r as getPublicGalleryFn, t as getCourseBySlugFn } from "./functions-BQXZ2nMb.mjs";
...
import { E as ArrowUpRight, n as X, s as Phone, u as Menu } from "../_libs/lucide-react.mjs";
import { t as clsx } from "../_libs/clsx.mjs";
import { t as twMerge } from "../_libs/tailwind-merge.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/pieces-l00FVp0i.js
...
function Header() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "hidden lg:flex items-center justify-between px-6 py-2.5 bg-cobalt text-primary-foreground text-[0.7rem] font-semibold tracking-wide z-40 relative",
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("header", {
			className: "sticky top-4 left-0 right-0 z-50 flex justify-center px-4 pointer-events-none transition-transform mt-4",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(motion.div, {
				...
				className: cn("pointer-events-auto flex w-full max-w-5xl items-center gap-1 rounded-full border px-3 py-2 transition-all duration-500", scrolled ? "border-border/60 bg-background/80 shadow-[0_8px_32px_-8px_rgba(15,23,42,0.18)] backdrop-blur-2xl" : "border-border/40 bg-background/70 shadow-[0_4px_24px_-6px_rgba(15,23,42,0.12)] backdrop-blur-xl"),
				children: [
...
function PageHero({ eyebrow, title, lead, children }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			className: "shell relative py-16 sm:py-28",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Reveal, { children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
					className: "mt-6 max-w-4xl font-display text-4xl leading-[1.04] tracking-tight sm:text-6xl lg:text-7xl",
					children: title
				}),
