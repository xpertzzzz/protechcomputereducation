...
import { D as CodeXml, M as BrainCircuit, P as ArrowUpRight, S as Globe, o as Terminal, s as Star, t as Zap } from "../_libs/lucide-react.mjs";
import { c as SiteShell, f as usePublicCourses, l as WordReveal, m as usePublicTestimonials, n as Counter, o as Reveal, p as usePublicGallery, r as EmptyState, s as SectionHead, t as ArrowLink, u as cn } from "./pieces-dZJcImtG.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/routes-D_cILkxG.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "shell relative grid gap-14 pt-12 pb-16 lg:grid-cols-[1fr_1fr] lg:items-center lg:gap-12 lg:pt-20 lg:pb-20",
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: images.slice(0, 8).map((img, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Reveal, {
					delay: i * .05,
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "group relative aspect-[4/3] w-full overflow-hidden rounded-3xl border border-border/50 bg-card shadow-sm transition-all hover:-translate-y-1 hover:border-cobalt/40 hover:shadow-[0_20px_40px_-15px_rgba(0,0,0,0.15)]",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
							...
							className: "absolute bottom-0 left-0 right-0 flex flex-col gap-1 border-t border-border/50 bg-background/95 px-5 py-4 opacity-0 backdrop-blur-sm transition-all duration-300 group-hover:translate-y-0 group-hover:opacity-100 translate-y-full",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "text-sm font-semibold text-foreground",
								children: img.title ?? "Untitled"
							}), img.category && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "text-[0.65rem] font-bold uppercase tracking-wider text-cobalt",
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
					...
					children: ["See full gallery", /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowUpRight, { className: "h-4 w-4 transition-transform duration-300 group-hover:translate-x-0.5 group-hover:-translate-y-0.5" })]
				})
			})
		]
	});
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionHead, {
					...
					children: ["See all testimonials", /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowUpRight, { className: "h-4 w-4 transition-transform duration-300 group-hover:translate-x-0.5 group-hover:-translate-y-0.5" })]
				})]
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "mt-14",
				children: isLoading ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: [
						...
						1,
						2
					].map((i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "h-64 animate-pulse rounded-3xl bg-surface-2" }, i))
					...
					children: items.slice(0, 3).map((t, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Reveal, {
						delay: i % 3 * .08,
						className: "h-full",
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										...
										className: "text-[0.95rem] text-foreground/80 leading-relaxed italic font-medium line-clamp-5",
										children: [
											"\"",
											t.content,
											"\""
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Reveal, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
				...
				children: "Ready to build your career? Join Protech Computer Education today."
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
